...
<section id="form">
  <div class="container">
    ...
    <!-- 👇 id add kar diya -->
    <form id="complaintForm" class="p-4 border rounded bg-light shadow-sm">
    ...
    <!-- 👇 yeh jagah success message show hoga -->
...
<script>
  document.getElementById("complaintForm").addEventListener("submit", function(e) {
      ...
      document.getElementById("message").innerText = "✅ Complaint submitted successfully! (Demo Only)";

      // optional: form ko reset kar dega
      this.reset();
  });
</script>
